...
namespace {
  ...
  const char *help_text_alter_table[] = {
    ...
    "",
    "    replication_definition:",
    "      REPLICATE TO 'cluster-id' [ON]",
    "      | REPLICATE TO 'cluster-id' OFF",
    "",
    "    duration:",
    "      num MONTHS",
    "      | num WEEKS",
  ...
  const char *help_text_create_table[] = {
    ...
    "REPLICATE TO table option (or with the REPLICATE TO option of ALTER TABLE).  ",
  ...
  const char *help_text_drop_namespace[] = {
    ...
    "A namespace can only be dropped if it is empty (ie contains no tables or sub-namespaces",
    "If namespace_name starts with '/' it treats the namespace_name as an absolute path, ",
    "otherwise it considers it to be a sub-namespace relative to the current namespace.",
    "",
    0
