...
void Range::initialize() {
  ...
  HT_ASSERT(m_metalog_entity->state.transfer_log == 0 || *m_metalog_entity->state.transfer_log == 0 ||
	    m_metalog_entity->state.transfer_log[strlen(m_metalog_entity->state.transfer_log)] != '/');
